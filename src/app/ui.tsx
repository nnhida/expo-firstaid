...
export default function Ui({ postListHome }: uiProps) {
    ...
    return (        <div>
            ...
            <section id='about' className=' flex items-center justify-between px-40 w-screen'>
                ...
                <div className='flex-col space-y-32 w-max'>
                    ...
                    <div className='flex space-x-10'>
                        {[
                            ...
                            <div key={index} className='flex-col group space-y-5 w-64 p-5 rounded-xl hover:bg-blue-700 shadow-xl transition-all'>
            ...
            <section id='blog' className=' flex items-center w-screen h-screen'>
                <div className='flex-col space-y-10'>
            ...
            <section id="contact" className="py-20 w-screen bg-gray-100">
                <h1 className="text-4xl text-center text-blue-600 mb-4">Contact Us</h1>
                <h3 className="text-2xl text-center text-gray-700 mb-12">
